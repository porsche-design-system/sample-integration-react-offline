...
import { getFieldsetCss as getComponentCss$17 } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRFieldset extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$17(this.props.state, this.props.labelSize, (this.props.label || namedSlotChildren.filter(({ props: { slot } }) => slot === 'label').length > 0), this.props.theme));
