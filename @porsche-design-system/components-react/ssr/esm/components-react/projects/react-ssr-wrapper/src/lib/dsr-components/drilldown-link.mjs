...
import { getDrilldownLinkCss as getComponentCss$19 } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRDrilldownLink extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$19(hasSlottedAnchor, this.props.active));
