...
import { DSRInputTime } from '../dsr-components/input-time.mjs';

const PInputTime = /*#__PURE__*/ forwardRef(({ autoComplete, compact = false, description = '', disabled = false, form, hideLabel = false, label = '', loading = false, max, message = '', min, name, onBlur, onChange, onInput, readOnly = false, required = false, state = 'none', step = 60, theme, value = '', className, children, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                children: (jsx(DSRInputTime, { autoComplete, compact, description, disabled, form, hideLabel, label, loading, max, message, min, name, readOnly, required, state, step, theme: theme || useTheme(), value, children })),
            }
            : {
                children,
