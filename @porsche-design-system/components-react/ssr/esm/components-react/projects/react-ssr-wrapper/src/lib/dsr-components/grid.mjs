...
import { getGridCss as getComponentCss$11 } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRGrid extends Component {
    ...
    render() {
        ...
        const manipulatedChildren = children.map((child) => typeof child === 'object' && 'props' in child && otherChildren.includes(child)
            ...
            : child);
        const style = minifyCss(getComponentCss$11(this.props.direction, this.props.wrap));
