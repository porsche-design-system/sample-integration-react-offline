...
import { getInputEmailCss as getComponentCss$X } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRInputEmail extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$X(this.props.disabled, this.props.loading, this.props.hideLabel, this.props.state, this.props.compact, this.props.readOnly, this.props.theme));
