...
import { getIconCss as getComponentCss$_ } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRIcon extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$_(this.props.name, this.props.source, (deprecationMap[this.props.color] || this.props.color), this.props.size, this.props.theme));
