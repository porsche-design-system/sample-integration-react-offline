...
import { getDisplayCss as getComponentCss$1d } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRDisplay extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1d(this.props.size, (alignDeprecationMap[this.props.align] || this.props.align), this.props.color, this.props.ellipsis, this.props.theme));
