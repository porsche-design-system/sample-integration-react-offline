...
import { getInputPasswordCss as getComponentCss$U } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRInputPassword extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$U(this.props.disabled, this.props.loading, this.props.hideLabel, this.props.state, this.props.toggle, this.props.compact, this.props.readOnly, this.props.theme));
