...
const PInputTel = /*#__PURE__*/ forwardRef(({ autoComplete, compact = false, description = '', disabled = false, form, hideLabel = false, indicator = false, label = '', loading = false, maxLength, message = '', minLength, name, onBlur, onChange, onInput, pattern, placeholder = '', readOnly = false, required = false, state = 'none', theme, value = '', className, children, ...rest }, ref) => {
    ...
    const WebComponentTag = usePrefix('p-input-tel');
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                children: (jsx(DSRInputTel, { autoComplete, compact, description, disabled, form, hideLabel, indicator, label, loading, maxLength, message, minLength, name, pattern, placeholder, readOnly, required, state, theme: theme || useTheme(), value, children })),
            }
            : {
                children,
