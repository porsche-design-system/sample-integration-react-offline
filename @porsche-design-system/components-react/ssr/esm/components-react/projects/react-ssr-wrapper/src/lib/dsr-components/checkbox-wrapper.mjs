...
import { getCheckboxWrapperCss as getComponentCss$1h } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRCheckboxWrapper extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1h(this.props.hideLabel, this.props.state, disabled, this.props.loading, this.props.theme));
