...
import { getContentWrapperCss as getComponentCss$1f } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRContentWrapper extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1f(this.props.width));
