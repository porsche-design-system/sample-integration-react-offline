...
import { getFieldsetWrapperCss as getComponentCss$18 } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRFieldsetWrapper extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$18(this.props.state, this.props.labelSize, (this.props.label || namedSlotChildren.filter(({ props: { slot } }) => slot === 'label').length > 0), this.props.theme));
