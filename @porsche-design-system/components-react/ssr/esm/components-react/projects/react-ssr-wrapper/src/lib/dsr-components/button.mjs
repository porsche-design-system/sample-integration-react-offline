...
import { getButtonCss as getComponentCss$1k } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRButton extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1k(this.props.icon, this.props.iconSource, this.props.variant, this.props.hideLabel, this.props.disabled, this.props.loading, this.props.compact, this.props.theme));
