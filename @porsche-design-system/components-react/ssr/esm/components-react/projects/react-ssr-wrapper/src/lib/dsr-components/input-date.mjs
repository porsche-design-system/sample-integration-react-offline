...
import { getInputDateCss as getComponentCss$Y } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRInputDate extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$Y(this.props.disabled, this.props.loading, this.props.hideLabel, this.props.state, this.props.compact, this.props.readOnly, this.props.theme));
