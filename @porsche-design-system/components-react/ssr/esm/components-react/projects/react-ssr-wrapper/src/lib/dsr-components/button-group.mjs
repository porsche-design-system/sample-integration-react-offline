...
import { getButtonGroupCss as getComponentCss$1n } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRButtonGroup extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1n(this.props.direction));
