...
import { getInlineNotificationCss as getComponentCss$Z } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRInlineNotification extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$Z(this.props.state, !!this.props.actionLabel, this.hasDismissButton, this.props.theme));
