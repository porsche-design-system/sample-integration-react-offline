...
import { getInputNumberCss as getComponentCss$V } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRInputNumber extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$V(this.props.disabled, this.props.loading, this.props.hideLabel, this.props.state, this.props.compact, this.props.readOnly, this.props.theme, this.props.controls));
