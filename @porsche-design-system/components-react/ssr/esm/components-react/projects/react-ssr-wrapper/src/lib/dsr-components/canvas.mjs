...
import { getCanvasCss as getComponentCss$1j } from '../../../../../../components/dist/styles/esm/styles-entry.mjs';
...
class DSRCanvas extends Component {
    ...
    render() {
        ...
        const style = minifyCss(getComponentCss$1j(this.props.theme, this.props.sidebarStartOpen, this.props.sidebarEndOpen));
