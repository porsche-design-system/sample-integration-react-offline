...
class DSRFlexItem extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getFlexItemCss(this.props.width, this.props.offset, this.props.alignSelf, this.props.grow, this.props.shrink, this.props.flex));
