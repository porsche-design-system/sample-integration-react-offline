...
const PFlyout = /*#__PURE__*/ react.forwardRef(({ aria, backdrop = 'blur', disableBackdropClick = false, footerBehavior = 'sticky', onDismiss, onMotionHiddenEnd, onMotionVisibleEnd, open = false, position = 'end', theme, className, children, ...rest }, ref) => {
    ...
    const props = {
        ...
        ...(!process.browser
            ? {
                children: (jsxRuntime.jsx(flyout.DSRFlyout, { aria, backdrop, disableBackdropClick, footerBehavior, open, position, theme: theme || hooks.useTheme(), children })),
            }
            : {
                children,
