...
class DSRHeading extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getHeadingCss(this.props.size, (alignDeprecationMap[this.props.align] || this.props.align), this.props.color, this.props.ellipsis, this.props.theme));
