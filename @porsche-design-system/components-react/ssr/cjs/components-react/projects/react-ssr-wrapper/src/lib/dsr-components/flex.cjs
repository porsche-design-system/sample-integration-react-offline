...
class DSRFlex extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getFlexCss(this.props.inline, this.props.wrap, this.props.direction, this.props.justifyContent, this.props.alignItems, this.props.alignContent));
