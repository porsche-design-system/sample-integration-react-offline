...
class DSRTextarea extends react.Component {
    ...
    render() {
        ...
        const id = 'textarea';
        const style = minifyCss.minifyCss(stylesEntry.getTextareaCss(this.props.disabled, this.props.readOnly, this.props.hideLabel, this.props.state, this.props.compact, this.props.counter, this.props.resize, this.props.theme));
