...
class DSRIcon extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getIconCss(this.props.name, this.props.source, (deprecationMap[this.props.color] || this.props.color), this.props.size, this.props.theme));
