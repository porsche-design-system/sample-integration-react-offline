...
class DSRDivider extends react.Component {
    ...
    render() {
        ...
        const style = minifyCss.minifyCss(stylesEntry.getDividerCss((deprecationMap[this.props.color] || this.props.color), this.props.orientation || this.props.direction, this.props.theme));
