...
var inputMonth_wrapper = require('./lib/components/input-month.wrapper.cjs');
...
var inputWeek_wrapper = require('./lib/components/input-week.wrapper.cjs');
...
var radioGroup_wrapper = require('./lib/components/radio-group.wrapper.cjs');
var radioGroupOption_wrapper = require('./lib/components/radio-group-option.wrapper.cjs');
...
exports.PInputMonth = inputMonth_wrapper.PInputMonth;
...
exports.PInputWeek = inputWeek_wrapper.PInputWeek;
...
exports.PRadioGroup = radioGroup_wrapper.PRadioGroup;
exports.PRadioGroupOption = radioGroupOption_wrapper.PRadioGroupOption;
